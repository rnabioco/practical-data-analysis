...
growth_plots[[1]] <- brauer_gene_exp %>%
  plot_growth(sys_name = "YDL104C")

growth_plots[[2]] <- brauer_gene_exp %>%
  plot_growth(sys_name = "YOR069W")

growth_plots[[3]] <- brauer_gene_exp %>%
  plot_growth(sys_name = "YLR115W")

growth_plots[[4]] <- brauer_gene_exp %>%
  plot_growth(sys_name = "YPR036W")
...
growth_plots <- map(genes, plot_growth, input = brauer_gene_exp)
