...
ensg_tibble2 <- ensg_tibble %>% mutate(gene = str_replace(gene, 
...
gene_tibble_as3 <- gene_tibble_as2 %>% mutate(gene = str_sub(gene, 2, 4)) # from gene name, "HUMAN-ELOVL2-AS1", 2-4 characters are "UMA"
...
genes_human <- getLDS(attributes = c("hgnc_symbol"), # "linked"
                      filters = "hgnc_symbol", 
                      mart = human_mart, 
