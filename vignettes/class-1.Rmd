...
qpcr_names_tidy <- separate(qpcr_names_tidy,
                           value,
...
1. Tidy the `mtcars` data set. Note that car names are rownames in the built-in data, so they need to be moved to their own column prior to tibble conversion.
