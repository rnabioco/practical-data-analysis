---
title: "Class 4: RNA-seq Analysis part 1"
...
## Before we get started: Install Bioconductor packages and update pbda
...
The exercises for today's class are presented [here](https://rnabioco.github.io/pbda/articles/problem-set-3.html), Here is a [link](https://github.com/IDPT7810/practical-data-analysis/blob/master/vignettes/problem-set-3.Rmd) to the raw text of these exercises
