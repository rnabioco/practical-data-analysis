---
title: "Class 6: RNA-seq Analysis part 1"
...
## Filtering genes with little or no expression
...
## Stabilizing the variance across the mean for visualizing count data
...
The exercises for today's class are presented [here](https://rnabioco.github.io/eda/articles/exercises-5.html), Here is a [link](https://raw.githubusercontent.com/rnabioco/eda/master/vignettes/exercises-5.Rmd) to the raw text of these exercises
